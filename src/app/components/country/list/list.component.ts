...
export class ListComponent extends BaseComponent implements OnInit {
    ...
    modalRef: BsModalRef;
    public loader = true;
    public countryListConfig: ListModel;
    public isCollapsed = true;
    public countrySearchTableOptions: Array<Object>;
    ...
    public COUNTRY_EXPORT_API = Constant.REST_API.COUNTRY.EXPORT_SELECTED;
    public COUNTRY_EXPORT_ACTION = Constant.MODULE_ACTIONS.COUNTRY.VIEW;
   ...
   constructor(
      ...
      this.countryListConfig = new ListModel();
    ...
    processInitials() {
      ...
      this.countrySearchTableOptions = [
        {
          type: 'text',
          'fieldName': 'countryId',
          'labelName': 'COMMON.LABELS.ID',
          fieldValue: '',
          defaultValue: this.queryParams.countryId ? this.queryParams.countryId : ''
        }, {
          type: 'text',
          'fieldName': 'countryCode',
          'labelName': 'COUNTRY.FORM_LABELS.CODE',
          fieldValue: '',
          defaultValue: this.queryParams.countryCode ? this.queryParams.countryCode : ''
        }, {
          type: 'text',
      ...
      this.countryListConfig.columns = [
        {
    ...
    loadList() {
      ...
      this.navigateByUrl('/country/view?' + paramRoute);
      ...
      try {
        this
          ...
          .subscribe((response) => {
            ...
            this.countryListConfig.rows = response.data;
            this.countryListConfig.totalRecords = response.totalItems;
            this.loader = false;
          },(error) => {
    ...
    */
    ...
    onCheckBoxSelect(row) {
      ...
      const selectedItems = _.filter(this.countryListConfig.rows, { 'selected': true });
    ...
    **/
    ...
    onAdd() {
      this.navigateByUrl('/country/add');
    }

    onEdit(item) {
      this.navigateByUrl('/country/edit/' + item.rid);
    }

    onView(item) {
      this.navigateByUrl('/country/view/' + item.rid);
    }
    ...
    onSelectAllCheckbox($event) {
      ...
      _.map(this.countryListConfig.rows, (obj) => obj.selected = this.allRowsSelected);
      this.selectedIdsArray();
    }
