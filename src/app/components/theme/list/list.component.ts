...
export class ListComponent extends BaseComponent implements OnInit {
  ...
  @ViewChild('defaultTmplCell') defaultTmplCell: TemplateRef<any>;
  ...
  public EXPORT_API = Constant.REST_API.THEMES.EXPORT_SELECTED;
    ...
    this.themeSearchTableOption = [
      {
        ...
        type: 'text',
        'fieldName': 'name',
        'labelName': 'THEME.FORM_LABELS.NAME',
        fieldValue: '',
        ...
        format: 'YYYY-MM-DD',
        'fieldName': 'startDate',
        'labelName': 'THEME.FORM_LABELS.START_DATE',
        fieldValue: '',
    ...
    this.themeListConfig = {
      ...
      columns: [
        ...
        },
        {
          ...
          headerTemplate: this.commonTmplHeader,
          cellTemplate: this.commonTmplCell,
          name: 'THEME.FORM_LABELS.START_DATE',
          sortable: true,
          draggable: false,
          flexGrow: 3,
          value: 'startDate'
          ...
          headerTemplate: this.commonTmplHeader,
          cellTemplate: this.commonTmplCell,
          name: 'THEME.FORM_LABELS.END_DATE',
          flexGrow: 4,
          sortable: true,
          draggable: false,
          value: 'endDate'
          ...
          headerTemplate: this.commonTmplHeader,
          cellTemplate: this.defaultTmplCell,
          name: 'THEME.FORM_LABELS.DEFAULT',
          sortable: true,
          flexGrow: 1,
          value: 'isDefault'
        }, {
 ...
 */
  ...
  loadThemesList() {
    ...
    this.navigateByUrl('/themes/list?' + paramRoute);
 ...
 */
  ...
  **/
  ...
  onAdd() {
    this.navigateByUrl('/themes/add');
  }

  onEdit(item) {
    this.navigateByUrl('/themes/edit/' + item.rid);
  }

  onView(item) {
    this.navigateByUrl('/themes/view/' + item.rid);
  }
  ...
  onSelectAllCheckbox($event) {
    ...
    _.map(this.themeListConfig['rows'], (obj) => {
      obj.selected = this.allRowsSelected;
      // if(!obj.isDefault){
      //   obj.selected = this.allRowsSelected
      // }      
    });
