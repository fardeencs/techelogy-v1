...
export class ListComponent extends BaseComponent implements OnInit {
    ...
    modalRef: BsModalRef;
    public loader = true;
    public currencyListConfig: ListModel;
    public isCollapsed = true;
    public currencySearchTableOptions: Array<Object>;
    ...
    public CURRENCY_EXPORT_API = Constant.REST_API.CURRENCY.EXPORT_SELECTED;
    public CURRENCY_EXPORT_ACTION = Constant.MODULE_ACTIONS.CURRENCY.VIEW;
    ...
    constructor(
      ...
      this.currencyListConfig = new ListModel();
    ...
    processInitials() {
      ...
      this.currencySearchTableOptions = [
        {
          type: 'text',
          'fieldName': 'currencyId',
          'labelName': 'COMMON.LABELS.ID',
          fieldValue: '',
          defaultValue: this.queryParams.currencyId ? this.queryParams.currencyId : ''
        }, {
          type: 'text',
          'fieldName': 'currency',
          'labelName': 'CURRENCY.FORM_LABELS.NAME',
          fieldValue: '',
          defaultValue: this.queryParams.currencyCode ? this.queryParams.currencyCode : ''
        }, {
          type: 'text',
          'fieldName': 'symbol',
          'labelName': 'CURRENCY.FORM_LABELS.SYMBOL',
          fieldValue: '',
          defaultValue: this.queryParams.currencyId ? this.queryParams.currencyId : ''
      ...
      this.currencyListConfig.columns = [
        {
        ...
        },
        {
          ...
          headerTemplate: this.commonTmplHeader,
          cellTemplate: this.commonTmplCell,
          name: 'CURRENCY.FORM_LABELS.NAME',
          sortable: true,
          flexGrow: 1,
          value: 'currency'
        }, {
          headerTemplate: this.commonTmplHeader,
          cellTemplate: this.commonTmplCell,
          name: 'CURRENCY.FORM_LABELS.SYMBOL',
          sortable: true,
          flexGrow: 1,
          value: 'symbol'
        }, {
    ...
    loadList() {
      ...
      this.navigateByUrl('/currency/view?' + paramRoute);
      ...
      try {
        this
          ...
          .subscribe((response) => {
            ...
            this.currencyListConfig.rows = response.data;
            this.currencyListConfig.totalRecords = response.totalItems;
            this.loader = false;
          },(error) => {
    ...
    */
    ...
    onCheckBoxSelect(row) {
      ...
      const selectedItems = _.filter(this.currencyListConfig.rows, { 'selected': true });
    ...
    **/
    ...
    onAdd() {
      this.navigateByUrl('/currency/add');
    }

    onEdit(item) {
      this.navigateByUrl('/currency/edit/' + item.rid);
    }

    onView(item) {
      this.navigateByUrl('/currency/view/' + item.rid);
    }
    ...
    onSelectAllCheckbox($event) {
      ...
      _.map(this.currencyListConfig.rows, (obj) => obj.selected = this.allRowsSelected);
      this.selectedIdsArray();
    }
